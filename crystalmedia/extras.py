...
class StarfieldBackground:
    """Tiny ASCII starfield animation that can be sampled by screen draws."""

    def __init__(self, width: Optional[int] = None, height: Optional[int] = None, star_count: int = 28):
